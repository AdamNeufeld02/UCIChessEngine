...
void init_eval_weights_default() {
    ...
    for (int pt = 0; pt < PIECETYPECOUNT; ++pt) {
        W.material[PHASEMG][pt] = mgMat[pt];
        W.material[PHASEEG][pt] = mgMat[pt];
    }
...
Value evaluate(Board& board) {
    ...
    int mgScore = board.material[PHASEMG][sideToMove] + board.psqtv[PHASEMG][sideToMove]
                  -board.material[PHASEMG][~sideToMove] - board.psqtv[PHASEMG][~sideToMove];
    int egScore = board.material[PHASEEG][sideToMove] + board.psqtv[PHASEEG][sideToMove]
                  -board.material[PHASEEG][~sideToMove] - board.psqtv[PHASEEG][~sideToMove];
